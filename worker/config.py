...
CAND_MIN_ATTENTION = float(os.getenv("CAND_MIN_ATTENTION", "0.20"))
CAND_MIN_CURVE_LIQ_USD = float(os.getenv("CAND_MIN_CURVE_LIQ_USD", "500"))
CREATOR_SCORE_MIN = float(os.getenv("CREATOR_SCORE_MIN", "0.60"))
CREATOR_RISK_WEIGHT = float(os.getenv("CREATOR_RISK_WEIGHT", "0.30"))
CAND_MAX_PER_HOUR = int(os.getenv("CAND_MAX_PER_HOUR", "5"))
CAND_IMPROVE_PCT = float(os.getenv("CAND_IMPROVE_PCT", "0.20"))
